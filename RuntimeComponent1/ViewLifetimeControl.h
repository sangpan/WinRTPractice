...
namespace winrt::RuntimeComponent1::implementation
{
    ...
    struct ViewLifetimeControl : ViewLifetimeControlT<ViewLifetimeControl>
    {
        ...
        event_token Released(Windows::Foundation::TypedEventHandler<RuntimeComponent1::ViewLifetimeControl, Windows::Foundation::IInspectable> const& handler);
        void Released(event_token const& token);
        event_token PropertyChanged(Windows::UI::Xaml::Data::PropertyChangedEventHandler const& handler);
        void PropertyChanged(event_token const& token);

        static RuntimeComponent1::ViewLifetimeControl CreateForCurrentView();
    ...
    private:
        ...
        event<Windows::Foundation::TypedEventHandler<RuntimeComponent1::ViewLifetimeControl, Windows::Foundation::IInspectable>> m_internalReleased;
